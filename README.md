...
Управление порядком элементов: С помощью свойства order можно изменять порядок отображения flex-элементов, не меняя их физическое расположение в HTML.
...
Основные свойства Flexbox: flex-direction, justify-content, align-items, flex-wrap. </br>
